...
I also learned that if you declare a variable and then use += on it before intializing the variable, "undefined" is added included in the beginning. You have to set the variable to an emtpy string first.
